        ...
        function ($rootScope, $http, $q) {
			return {
				get: function() {
			        ...
			        $http.get(ACTIVITI.CONFIG.contextRoot + '/account', {ignoreErrors: true})
    ...
    function ($rootScope, $http, authService, $q) {
      return {
        authenticate: function() {
          var deferred = $q.defer();
          $http.get(ACTIVITI.CONFIG.contextRoot + '/authenticate', {ignoreErrors: true, ignoreAuthModule: 'ignoreAuthModule'})
              .success(function (data, status, headers, config) {
                  $rootScope.account = data;
